...
class Grid:
    ...
    def __init__(self, DX=10, XMIN=0, l1=0, l2=0, l3=0, T1=0, T2=0):
        self.DX = DX
        self.XMIN = XMIN
        self.L1 = int(l1/DX)
        self.L2 = int(l2/DX)
        ...
        for i in range(self.NX-1):
            ...
            self.CELLS[i] = Cell()
            if ((i < self.L1 or (i >= (self.L1 + self.L2) and i < (self.L1 + self.L2 + self.L3))) and self.T1 == 1) or (self.T2 == 1 and i >= self.L1 and i < (self.L1 + self.L2)):
                self.CELLS[i].tree_cell()
            elif i >= (self.L1 + self.L2 + self.L3) or (self.T2 == 2 and i >= self.L1 and i < (self.L1 + self.L2)):
